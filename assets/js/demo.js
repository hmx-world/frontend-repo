...
demo = {
    ...
    initDashboardPageCharts: function() {
        ...
        var data = {
            labels: ['Check property', 'Redirect to other providers'],
            series: [
                [195,'','' ],
                ['',125]
            ]
        ...
        var data1 = {
            labels: ['Bungalow', 'Duplex','Flat', 'Two Rooms'],
            series: [
                [110,'','',''],
                ['',176,'',''],
                ['','',80,''],
        ...
        var chartActivity1 = Chartist.Bar('#chartActivity1', data1, options, responsiveOptions);
        var chartActivity2 = Chartist.Bar('#chartActivity2', data2, options, responsiveOptions);
    ...
    showNotification: function(from, align) {
        ...
        $.notify({
            icon: "nc-icon nc-app",
            message: "Welcome to <b>Hmx Bootstrap </b> - view properties, edit properties."
